        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item mx-2">
                    <a class="nav-link text-white" href="/dashboard_eleve">Accueil</a>
                </li>
                <li class="nav-item mx-2">
                    <a class="nav-link text-white" href="/mes_cours">Mes Cours</a> <!--C'est ce chemin -->
                </li>
                <li class="nav-item mx-2">
                    <a class="nav-link text-white" href="/voir_mes_notes">Mes Notes</a>
                </li>
            </ul>
